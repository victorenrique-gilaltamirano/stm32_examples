...
#include "usart1.h"
#include <stdarg.h>		// Libreria para el uso de varibles
...
void USART1_Config(u32 baund)
{
	...
	GPIO_StructureInit.GPIO_Speed = GPIO_Speed_10MHz;
	...
	/* Velocidad Baudios: baund
	   Longitud de palabra: 8 bits
		 Bit de Stop: 1
		 Paridad: Ninguna
		 Control de flujo: Ninguna  */
	USART_StructureInit.USART_BaudRate = baund;
	...
	/* Activamos el control de la interrupcion Rx */
...
void NVIC_Configuration(void){
	...
	/* Configuramos para NVIC el Grupo 0 de prioridad   */  
	NVIC_PriorityGroupConfig(NVIC_PriorityGroup_0);
	
	/* Configuramos los parametros para Interrupcion USARTx */
